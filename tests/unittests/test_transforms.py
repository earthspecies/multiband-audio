...
class TestBandGridConfig:
    def test_make_band_grid_basic(self) -> None:
    ...
    def test_make_band_grid_with_step(self) -> None:
    ...
    def test_make_band_grid_empty(self) -> None:
...
class TestHeterodyne:
    def test_basic_downsample(self) -> None:
    ...
    def test_same_sr_no_resample(self) -> None:
        het = HeterodyneToBaseband(HeterodyneCfg(baseband_sr=16000))
...
class TestMultibandTransform:
    ...
    def test_custom_max_freq(self) -> None:
...
class TestMultibandTransformDynamic:
    ...
    def test_low_sr_fallback(self) -> None:

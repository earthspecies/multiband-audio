...
from multiband_audio import LinearHead, MultibandTransform, MultibandWrapper, collate_fn
...
class TestCollateFn:
    ...
    def test_padding_mask_correct(self) -> None:
    ...
    def test_waveform_values_preserved(self) -> None:
    ...
    def test_label_types(self) -> None:
        ...
        batch_tensor = [(torch.randn(100), torch.tensor(0)), (torch.randn(50), torch.tensor(1))]
...
class TestTransformMaskPropagation:
    def test_no_mask_returns_tensor(self) -> None:
    ...
    def test_with_mask_returns_tuple(self) -> None:
    ...
    def test_band_mask_shape(self) -> None:
    ...
    def test_band_mask_dtype(self) -> None:
        t = MultibandTransform(sample_rate=48000)
        x = torch.randn(2, 48000)
        mask = torch.zeros(2, 48000, dtype=torch.bool)
    ...
    def test_padding_preserved_in_band_mask(self) -> None:
    ...
    def test_zero_padding_propagates(self) -> None:
    ...
    def test_with_scores_and_mask(self) -> None:
    ...
    def test_with_scores_no_mask(self) -> None:
...
class TestFullPipeline:
    def _make_wrapper(self, embed_dim: int = 64, num_classes: int = 5) -> MultibandWrapper:
    ...
    def test_collate_to_wrapper(self) -> None:
    ...
    def test_masked_and_unmasked_logits_differ_for_padded_sample(self) -> None:
    ...
    def test_backward_with_mask(self) -> None:
    ...
    def test_equal_length_batch_mask_is_all_false(self) -> None:
